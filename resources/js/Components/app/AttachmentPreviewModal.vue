            ...
            <div class="fixed inset-0 overflow-y-auto">
              ...
              >
                ...
                >
                  ...
                  >
                  <button @click="closeModal" class="text-white absolute z-10 right-6 top-6 w-8 h-8 rounded-full hover:bg-black/5 transition flex items-center justify-center">
                        <XMarkIcon class="size-10" />
                    </button>
                    <div class="relative p-4 group">
                        <div class="flex items-center absolute text-white cursor-pointer opacity-0 group-hover:opacity-100 w-16 h-full left-0 bg-black/5">
                            <ChevronLeftIcon class="w-16" @click="prev"/>
                        </div>
                        <div class="flex items-center absolute text-white cursor-pointer opacity-0 group-hover:opacity-100 w-16 h-full right-0 bg-black/5">
