...
<template>
    <div class="mb-3 bg-white dark:text-gray-100 dark:bg-slate-900 border-2 border-transparent hover:border-indigo-500">
        <div class="flex items-center gap-2 py-2 px-3">
            ...
            <div class="flex justify-between flex-1">
                ...
                <div v-if="showRoleDropdown">
                    ...
                    <button @click="$emit('deleteUser', user)" :disabled="disableRoleDropdown" class="text-xs py-1.5 px-2 rounded bg-gray-700 hover:bg-gray-800 text-white capitalize ml-3 disabled:bg-gray-400">Delete</button>
                </div>
            </div>
        </div>
    </div>
